          ...
          <div className="p-8 border-2 border-gray-900 rounded-lg bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            ...
            <div className="grid grid-cols-1 mb-6">
              <button
                ...
                className="flex items-center justify-center gap-2 my-2 py-2.5 border-2 border-gray-900 rounded-lg font-bold text-sm hover:bg-gray-50 transition shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5"
              >
